...
exports.transformWithWrap = (path, title) => {
    ...
    const { toc } = transform_1.default(content, undefined, misc_1.getMaxHeaderLevel(), misc_1.wrapTitle(title), misc_1.isNoTitle(title), misc_1.getEntryPrefix(), misc_1.getEntireFlag());
